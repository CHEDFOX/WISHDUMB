...
// ensure `fetch` is available but avoid redeclaring the identifier
if (typeof globalThis.fetch === "undefined") {
  // If running on older Node, require node-fetch (only if needed)
  globalThis.fetch = (...args) => require("node-fetch")(...args);
}
// use globalThis.fetch when you need to call fetch — do NOT re-declare `const fetch = ...` repeatedly
